...
/**
 * Componente de barra de navegação (Navbar) principal do site.
 *
 * Contém links principais, ícones sociais, campo de busca e controle de tema.
 *
 * @returns {JSX.Element} Componente Navbar completo com menus responsivos.
 */
export const Navbar = () => {
  const searchInput = (
    <Input
